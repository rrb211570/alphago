        ...
        <div id='Goban'>
          <div width="319" height="319" >
            <svg width="319" height="319" style={{ padding: '5px 5px 0 0' }}>
              ...
              <circle stroke="hsl(8, 7%, 20%)" strokeWidth="0.7px" cx="14.5" cy="14.5" r="14.1375" shapeRendering="geometricPrecision" fill="url(#plain-black-14.5-187-gradient)"></circle>
              <defs>
          ...
          <div width="319" height="319" style={{ position: 'absolute', height: '326px', width: '326px' }}>
